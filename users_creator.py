...
def user_creator():
    for i in range(1, row_count()):
        ...
        browser.find_element(By.XPATH, "//input[@placeholder='Enter Last Name (Optional)']").send_keys(surname)
        browser.find_element(By.XPATH, "//input[@placeholder='Enter Your Email']").send_keys(email)
